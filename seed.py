...
COORDINATE_MAP = {
    ...
    '테니스 장': (37.44866610870164, 126.6512022264584),
...
spaces_data = [
    ...
    ('다목적구장 2', '운동장', '5남 쪽', 30),
    # 테니스 코트 (6개) - (프론트 기준 '테니스 코트'로 통일)
    ('제1테니스장 3번', '테니스 코트', '제1테니스장', 4),
    ('제1테니스장 4번', '테니스 코트', '제1테니스장', 4),
    ('제1테니스장 5번', '테니스 코트', '제1테니스장', 4),
    ('제2테니스장 6번', '테니스 코트', '제2테니스장', 4),
    ('제2테니스장 7번', '테니스 코트', '제2테니스장', 4),
    ('제2테니스장 8번', '테니스 코트', '제2테니스장', 4),
    # 농구장 (4개)
    ...
    # 피클볼 (5개) - (프론트 기준 '피클볼 코트'로 통일)
    ('피클볼 1코트', '피클볼 코트', '피클볼장', 4),
    ('피클볼 2코트 (우레탄)', '피클볼 코트', '피클볼장', 4),
    ('피클볼 3코트', '피클볼 코트', '피클볼장', 4),
    ('피클볼 4코트', '피클볼 코트', '피클볼장', 4),
